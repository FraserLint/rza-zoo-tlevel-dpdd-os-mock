...
export default function Hero() {
  return (
    <div className="relative w-full h-[600px] rounded-lg overflow-hidden shadow-lg border-4 border-[var(--forest-green)] my-4">
      <Image
        src="/tiger.png"
        alt="Majestic Tiger"
        fill
      ...
      <div className="absolute inset-0 flex items-end justify-end p-12">
        <div className="bg-white/90 p-8 rounded-lg shadow-lg max-w-2xl border-4 border-[var(--forest-green)]">
